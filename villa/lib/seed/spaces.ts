...
export const SPACES: Space[] = [
  ...
  { id: "out-entrance", name: "Main entrance", floor: "outdoor", kind: "entrance",
    note: "Approach from the south road, past the compound gate and parking apron." },
  ...
  { id: "out-front-garden", name: "Front garden", floor: "outdoor", kind: "garden",
    note: "South lawn between the compound wall and the built edge, within the 11'1\" front setback." },
  { id: "out-side-garden-east", name: "Side garden — east", floor: "outdoor", kind: "garden",
    note: "8'2\" side setback strip along the living-room elevation." },
  { id: "out-side-garden-west", name: "Side garden — west", floor: "outdoor", kind: "garden",
  ...
  { id: "out-deck", name: "Outdoor deck / sit-out", floor: "outdoor", kind: "deck",
    note: "Raised timber deck off the living room, east side." },
  ...
  { id: "gf-living", name: "Main living room", floor: "ground", kind: "living",
    dims: plan(17, 8, 21, 6), note: "The largest ground-floor volume; opens to the east deck." },
  ...
  { id: "gf-kitchen", name: "Kitchen", floor: "ground", kind: "kitchen",
    dims: plan(12, 6, 12, 10), note: "Main dry kitchen with island; opens to the wet kitchen." },
  { id: "gf-wet-kitchen", name: "Wet kitchen", floor: "ground", kind: "wet-kitchen",
    dims: plan(7, 6, 12, 10), note: "Heavy cooking, washing-up and ventilation-critical work." },
  { id: "gf-utility", name: "Utility", floor: "ground", kind: "utility",
    note: "West-side service yard off the wet kitchen. Not dimensioned on the plan." },
  ...
  { id: "ff-master", name: "Master bedroom", floor: "first", kind: "master-bedroom",
    dims: plan(20, 4, 14, 4), note: "North-west corner; the largest bedroom in the villa." },
  ...
  { id: "ff-bed3", name: "Bedroom 3", floor: "first", kind: "bedroom",
    dims: plan(17, 8, 12, 6), note: "North-east bedroom. The plan shows a fitted wardrobe run, not a walk-in." },
  ...
  { id: "ff-bed4", name: "Bedroom 4", floor: "first", kind: "bedroom",
    dims: plan(12, 6, 20, 9), note: "South-west bedroom, the deepest plan on this floor." },
  ...
  { id: "ff-puja", name: "Puja room", floor: "first", kind: "puja",
    dims: plan(6, 0, 7, 6), note: "Off the family lounge, east side." },
  { id: "ff-sitout", name: "Covered sit-out / balcony", floor: "first", kind: "balcony",
    dims: plan(17, 6, 7, 8), note: "South-facing, sheltered by the second-floor overhang." },
