...
export function buildContent(items: ScopeItem[]): Curated {
  ...
  docs.push(
    ...
    { id: "d-theatre-layout", title: "Theatre layout & long section — provisional", kind: "furniture",
      spaceIds: ["sf-theatre"], scopeItemIds: [], revision: "Provisional",
      addedAt: D("2026-09-20"), addedBy: "Harsha", url: "/drawings/theatre-layout.png" },
