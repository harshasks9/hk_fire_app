...
export function Briefing({ initialLines }: { initialLines: string[] }) {
  ...
  return (
    <div className="rounded-xl border border-dashed border-accent-soft-2 bg-accent-soft/40 px-4 py-3.5">
      <div className="mb-1.5 flex items-center gap-1.5 text-[11.5px] font-semibold uppercase tracking-[0.06em] text-accent"><Sparkles className="h-3.5 w-3.5" /> Today</div>
