 ...
 *
 * This is a pure function over the Fetch API so it can be unit-tested in Node and
 * run unchanged at Vercel's edge (see middleware.ts). It returns a Response when
 * it wants to intercept the request, and undefined when the request may proceed.
 *
