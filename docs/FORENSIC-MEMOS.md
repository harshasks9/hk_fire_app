...
Two subjects, both cut on **31 July 2026** and revalidated on **28 August 2026**:

| | Blue Owl (NYSE: OWL) | Patria (NASDAQ: PAX) |
|---|---|---|
| Latest period | Q2 2026, reported 30 Jul 2026 | Q2 2026, reported 31 Jul 2026 |
| Price at cut → now | $9.35 → $12.11 | $11.37 → $11.66 |
| Rating at cut → now | Moderately undervalued → Fairly valued | Moderately undervalued (held) |
...
build.ts          Data model → HTML. 18 sections per memo, driven entirely by the data
```
...
every prediction made it onto the page, with nothing left as `undefined` or `NaN`.
