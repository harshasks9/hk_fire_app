    ...
    <div className="mx-auto w-full max-w-[1080px] px-5 sm:px-8">
      <section className="py-16 text-center sm:py-24">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link href="/login" className="rounded-xl border border-border-2 px-5 py-3 text-[15px] font-medium hover:bg-surface-2">Sign in</Link>
        </div>
        {settings.signupMode === 'open' && !session && authEnabled() ? <p className="mt-3 text-[12.5px] text-fg-3">Free. No card, no trial clock.</p> : null}
