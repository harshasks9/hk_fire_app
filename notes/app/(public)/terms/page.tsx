...
export default async function TermsPage() {
  ...
  return (
    <article className="mx-auto w-full max-w-[720px] px-5 py-14 text-[15px] leading-relaxed text-fg-2 sm:px-8">
      ...
      <h2 className="mt-6 text-[18px] font-semibold text-fg">4. Cost</h2>
      <p>The service is free. There are no plans, trials or payments. We may apply fair-use limits to keep the service healthy for everyone and will say so in the app if we do.</p>
      <h2 className="mt-6 text-[18px] font-semibold text-fg">5. Acceptable use</h2>
      <p>Do not use the service to store unlawful content, to attack it or other people's notebooks, or to load it by automated means beyond ordinary personal use. We may suspend accounts that do.</p>
      ...
      <p>The service is provided as is. AI output can be wrong; verify anything that matters. To the extent the law allows, we accept no liability for loss arising from use of a free service.</p>
