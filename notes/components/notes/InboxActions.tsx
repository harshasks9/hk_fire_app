...
import { Zap, Mic, Link2, FileUp } from 'lucide-react'
...
export function InboxActions() {
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <Button size="sm" variant="secondary" onClick={() => setShell({ uploadOpen: true })} title="Upload documents"><FileUp className="h-3.5 w-3.5" /> Upload</Button>
